...
public interface IChangelogRenderer<VHHeader extends RecyclerView.ViewHolder, VHRow extends RecyclerView.ViewHolder, VHMore extends RecyclerView.ViewHolder, VHImage extends RecyclerView.ViewHolder> extends Parcelable {
    ...
    VHImage createImageViewHolder(LayoutInflater inflater, ViewGroup parent, ChangelogBuilder builder);
    ...
    void bindImage(ChangelogRecyclerViewAdapter adapter, Context context, VHImage viewHolder, ItemImage image, ChangelogBuilder builder);
}
