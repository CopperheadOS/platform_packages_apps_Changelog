...
public class ChangelogRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == Type.Header.ordinal()) {
            ...
            return mBuilder.getRenderer().createImageViewHolder(mInflater, parent, mBuilder);
        } else {
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        } else if (getItem(position).getRecyclerViewType() == Type.Image) {
            mBuilder.getRenderer().bindImage(this, mContext, viewHolder, (ItemImage) getItem(position), mBuilder);
        }
    }
