...
public class ChangelogRenderer implements IChangelogRenderer<ChangelogRenderer.ViewHolderHeader, ChangelogRenderer.ViewHolderRow, ChangelogRenderer.ViewHolderMore, ChangelogRenderer.ViewHolderImage> {
    ...
    @Override
    public ViewHolderImage createImageViewHolder(LayoutInflater inflater, ViewGroup parent, ChangelogBuilder builder) {
        return new ViewHolderImage(inflater.inflate(R.layout.changelog_image, parent, false), builder);
    }
    ...
    public static class ViewHolderImage extends RecyclerView.ViewHolder {
        ...
        public ViewHolderImage(View itemView, ChangelogBuilder builder) {
            super(itemView);
            imageView = itemView.findViewById(R.id.changelog_image);
        }
    }
